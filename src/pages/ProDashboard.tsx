...
const ProDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'portfolios' | 'templates' | 'domains' | 'billing'>('overview');
      ...
      <header className="border-b border-stone-200 bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link to="/templates">
                <button className="px-4 py-2 bg-orange-600 hover:bg-orange-500 text-white rounded-lg text-sm font-semibold transition">
                  Create New
                </button>
              </Link>
        ...
        {loading ? (
          ...
          <>
              ...
              <div className="space-y-5">
                <div className="bg-white border border-stone-200 rounded-2xl p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <Link to="/templates">
                      <button className="w-full bg-orange-600 hover:bg-orange-500 text-white py-3.5 px-6 rounded-xl font-semibold transition flex items-center justify-center gap-2">
                ...
                <div className="bg-white border border-stone-200 rounded-2xl p-6">
                  ...
                  {portfolios.length === 0 ? (
                    <div className="text-center py-10">
                      ...
                      <Link to="/templates">
                        <button className="bg-orange-600 hover:bg-orange-500 text-white px-5 py-2 rounded-lg text-sm font-semibold transition">
            ...
            {activeTab === 'portfolios' && (
              <div className="bg-white border border-stone-200 rounded-2xl p-6">
                <h2 className="text-lg font-bold text-stone-900 mb-5">All Portfolios</h2>
                {portfolios.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-stone-400 text-sm mb-4">No portfolios yet</p>
                    <Link to="/templates">
                      <button className="bg-orange-600 hover:bg-orange-500 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition">
                        Create Your First Portfolio
                      </button>
                    </Link>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    {portfolios.map((portfolio) => (
                      <div key={portfolio.id} className="bg-stone-50 border border-stone-200 rounded-xl p-5 hover:border-stone-300 transition-all">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <h3 className="font-bold text-stone-900">{portfolio.user_name}</h3>
                            <p className="text-xs text-stone-400 mt-0.5">{portfolio.template_id}</p>
                          </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <Link to={getEditRoute(portfolio)} className="flex-1">
                            <button className="w-full bg-orange-600 hover:bg-orange-500 text-white py-2 px-3 rounded-lg text-sm font-semibold transition">
                              Edit
                            </button>
                          </Link>
                          <button
                        ...
                        {portfolio.deployed_url && (
                          <div className="mt-3 p-2.5 bg-green-50 border border-green-100 rounded-lg flex items-center gap-2">
                            ...
                            <a href={portfolio.deployed_url} target="_blank" rel="noopener noreferrer" className="text-green-600 text-xs hover:underline break-all">
                              {portfolio.deployed_url}
                            </a>
                          </div>
                        )}
            ...
            {activeTab === 'templates' && (
              <div className="space-y-5">
                <div className="bg-white border border-stone-200 rounded-2xl p-6">
                  ...
                  <Link to="/templates">
                    <button className="bg-orange-600 hover:bg-orange-500 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition flex items-center gap-2">
                ...
                <div className="bg-white border border-stone-200 rounded-2xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={() => setShowDomainForm(!showDomainForm)}
                      className="bg-orange-600 hover:bg-orange-500 text-white px-4 py-2 rounded-lg text-sm font-semibold transition flex items-center gap-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                      </svg>
                      Add Domain
                    ...
                    <div className="mb-5 bg-stone-50 border border-stone-200 rounded-xl p-5">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-3">
                          <button onClick={handleAddDomain} className="flex-1 bg-orange-600 hover:bg-orange-500 text-white py-2.5 px-5 rounded-xl text-sm font-bold transition">
                            Add Domain
                          </button>
                          ...
                          {!domain.verified && (
                            <div className="mt-3 p-4 bg-white border border-stone-200 rounded-xl">
                              ...
                              <button onClick={() => handleVerifyDomain(domain.domain, domain.portfolio_slug, domain.id)}
                                className="mt-3 w-full bg-orange-600 hover:bg-orange-500 text-white py-2.5 rounded-xl text-sm font-bold transition">
                                Check Verification
                              </button>
                            </div>
                          )}
