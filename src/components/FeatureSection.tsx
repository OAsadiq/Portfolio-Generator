const Feature = () => {
  return (
    <div className="grid grid-cols-1 gap-12 py-10 px-4 md:px-12 lg:px-24">
      {/* Box 1 */}
      <div className="rounded-4xl flex flex-col lg:flex-row items-center bg-slate-800/50 border border-slate-700/50 overflow-hidden backdrop-blur-sm">
        <div className="w-full lg:w-1/2 text-center p-8 md:p-12">
          <h2 className="text-slate-50 text-3xl md:text-4xl font-bold mb-2">
            Showcase Your Best Work
          </h2>
          <p className="text-slate-300 text-md md:text-lg font-semibold">
      ...
      {/* Box 2 */}
      <div className="rounded-4xl flex flex-col lg:flex-row-reverse items-center bg-slate-800/50 border border-slate-700/50 overflow-hidden backdrop-blur-sm">
        <div className="w-full lg:w-1/2 text-center p-8 md:p-12">
          <h2 className="text-slate-50 text-3xl md:text-4xl font-bold mb-2">
