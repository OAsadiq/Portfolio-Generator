...
export const TEMPLATE_CONFIGS: Record<string, TemplateConfig> = {
  ...
  'professional-writer-template': {
    ...
    fields: {
      ...
      email: 'jordan@example.com',
      social1: 'https://linkedin.com/in/jordan',
      social2: 'https://twitter.com/jordan',
      social3: 'https://jordan.design',
  ...
  'modern-writer-template': {
    ...
    fields: {
      ...
      social1: 'https://linkedin.com/in/alex',
      social2: 'https://github.com/alex',
      social3: 'https://dribbble.com/alex',
      primaryColor: '#4f46e5',
      accentColor: '#4f46e5',
      availability: 'true',
      availabilityText: 'Available for work',
